 ...
 */
public class MysqlDefaultPsServlet extends HttpServlet {
    String driver = DataConf.mysql_driver;
    String url = DataConf.mysql_connectUrl;
    String username = DataConf.mysql_name;
    String password = DataConf.mysql_password;
